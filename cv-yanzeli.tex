...
%-----------------------------------------------------------------------
	...
	\begin{itemize}
		\item My area of interest is \textbf{Static Analysis} and \textbf{Programming Language}. 
		In particular, I'm interested in developing efficient static analysis that can scale to extremely large codebase and various code changes with an emphasis on concurrency-related bugs.
...
%-----------------------------------------------------------------------
	...
	\begin{tablist}
		\item[\textbf{Crappie}] 
		\tab (Ongoing project) An efficient incremental race detection engine that can scale to distributed systems and Android apps
		\item[\textbf{SWORD}] 
		\tab A whole program race detector on Java source code and has been integrated into Eclipse.
	\end{tablist}
...
%-----------------------------------------------------------------------
	...
	\begin{itemize}
		...
		\item Java, Scala, Idris, OCaml, JavaScript, Python, Ruby, C/C++
