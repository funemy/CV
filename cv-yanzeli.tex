...
\item My research interest lies in program verification and static analysis, as well as their applications on real complex systems. I also enjoy the formal aspects of programming language, such as type system, language semantics and design, especially leveraging them to facilitate tasks like verification, synthesis, resource analysis, etc.
